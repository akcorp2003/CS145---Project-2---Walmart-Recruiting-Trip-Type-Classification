...
public class FrequentItemsetMiner {
	 ...
	 */
	public Map<ArrayList<String>, Integer> Mine(double minSupCount, double confidence) {
		...
		Map<ArrayList<String>, Integer> allCandidates = supCounts;
...
//		}
	 ...
	 * @return
	 */
	private Map<ArrayList<String>, Integer> MineCandidates(ArrayList<ArrayList<String>> prevCandidates, double minSupCount, int x){
...
//				}
	 ...
	 */
	private Map<ArrayList<String>, Integer> PruneMap(Map<ArrayList<String>, Integer> candidates, double minSup){
